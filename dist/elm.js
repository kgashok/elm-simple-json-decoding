...
var _user$project$Version$version = 'v3.0-beta-104-g02689cb';
...
var _user$project$Update$refreshGitterIDs = function (url) {
	return A3(
		...
		A2(_evancz$elm_http$Http$get, _user$project$Update$decodeGData, url));
};
				...
				if (_p7.ctor === 'Nothing') {
					...
					return {
						...
						_1: _elm_lang$core$Platform_Cmd$batch(
							A2(
								_elm_lang$core$List$map,
								_user$project$Update$gitterIDRequest(_p8),
								_user$project$Model$skipList(_p8.userCount)))
					};
				}
	...
	return A2(
		...
		_elm_lang$core$Native_List.fromArray(
			[
				...
				_elm_lang$core$Native_List.fromArray(
					[
						_elm_lang$html$Html_Events$onClick(_user$project$Update$FetchData)
					]),
				_elm_lang$core$Native_List.fromArray(
					[
					...
					[
						...
						_elm_lang$core$Native_List.fromArray(
							[
								...
								_elm_lang$html$Html_Attributes$checked(model.min5),
								_elm_lang$html$Html_Events$onCheck(_user$project$Update$Set5min)
							]),
						_elm_lang$core$Native_List.fromArray(
							[])),
						_elm_lang$html$Html$text('5 min')
					])),
				A2(
				_elm_lang$html$Html$label,
				_elm_lang$core$Native_List.fromArray(
				...
				_elm_lang$core$Native_List.fromArray(
					[
						...
						_elm_lang$core$Native_List.fromArray(
							[
								_elm_lang$html$Html_Attributes$type$('radio'),
								_elm_lang$html$Html_Attributes$checked(model.min15),
								_elm_lang$html$Html_Events$onCheck(_user$project$Update$Set15min)
							]),
						_elm_lang$core$Native_List.fromArray(
							[])),
						_elm_lang$html$Html$text('15 min')
					])),
				A2(
...
var Elm = {};
Elm['Fcc'] = Elm['Fcc'] || {};
_elm_lang$core$Native_Platform.addPublicModule(Elm['Fcc'], 'Fcc', typeof _user$project$Fcc$main === 'undefined' ? null : _user$project$Fcc$main);
