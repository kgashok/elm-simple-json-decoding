...
var _user$project$Model$excluded = {
	ctor: '::',
	_0: 'quincylarson',
	_1: {
		ctor: '::',
...
var _user$project$Model$SetMin15 = {ctor: 'SetMin15'};
...
var _user$project$Version$version = 'v3.0-beta-117-g8712c7d';
...
var _user$project$Update$decodeTitle = A2(
	_elm_lang$core$Json_Decode$at,
	{
		ctor: '::',
		_0: 'title',
...
var _user$project$Update$nestedListG = A4(
	...
	A2(_elm_lang$core$Json_Decode$field, 'userCount', _elm_lang$core$Json_Decode$int));
	...
	function (member, model) {
		...
		if (_p1 === true) {
			...
			return _elm_lang$core$Native_Utils.update(
				model_,
				{
					tList: {ctor: '::', _0: camper, _1: model.tList}
				});
		}
	});
...
var _user$project$Update$updateCHistory = F2(
	function (model, member) {
		var tList_ = A2(
			...
			function (x) {
				return !A2(_elm_lang$core$List$member, x.uname, model.exclude);
			},
			model.tList);
...
var _user$project$Update$nestedListGID = A4(
	...
	A2(_elm_lang$core$Json_Decode$field, 'avatarUrlSmall', _elm_lang$core$Json_Decode$string));
...
var _user$project$Update$Set5min = function (a) {
	return {ctor: 'Set5min', _0: a};
};
...
var _user$project$Update$refreshGitterIDs = function (url) {
	return A2(
		_elm_lang$core$Task$attempt,
		_user$project$Update$GitterStatus,
		_elm_lang$http$Http$toTask(
			A2(_elm_lang$http$Http$get, url, _user$project$Update$decodeGData)));
};
...
var _user$project$Update$FetchOne = function (a) {
	return {ctor: 'FetchOne', _0: a};
};
var _user$project$Update$makeRequest = function (url) {
	return A2(
		_elm_lang$core$Task$attempt,
		_user$project$Update$FetchOne,
		_elm_lang$http$Http$toTask(
			A2(_elm_lang$http$Http$get, url, _user$project$Update$decodeData)));
};
	...
	return A2(
		...
		{ctor: '[]'},
		{
			...
			_0: A2(
				...
				{
					ctor: '::',
					_0: _elm_lang$html$Html_Attributes$class('uname'),
					_1: {ctor: '[]'}
				},
				{
					ctor: '::',
					_0: _elm_lang$html$Html$text(camper.uname),
					_1: {ctor: '[]'}
				}),
			_1: {
				ctor: '::',
...
var _user$project$View$rStyle = _elm_lang$html$Html_Attributes$style(
	{
		ctor: '::',
		_0: {ctor: '_Tuple2', _0: 'backgroundColor', _1: '#ff6600'},
		_1: {
			ctor: '::',
			_0: {ctor: '_Tuple2', _0: 'color', _1: 'white'},
			_1: {
				ctor: '::',
				_0: {ctor: '_Tuple2', _0: 'fontSize', _1: '150%'},
				_1: {ctor: '[]'}
			}
		}
	});
...
var _user$project$Fcc$main = _elm_lang$html$Html$programWithFlags(
			...
			_1: {
				...
				_0: A2(
					...
					A2(
																					...
																					return A2(
																						...
																						function (points) {
																							return A2(
																															...
																															return A2(
																																...
																																function (ts) {
																																	return A2(
																																		...
																																		A2(_elm_lang$core$Json_Decode$field, 'uname', _elm_lang$core$Json_Decode$string));
																																},
																																A2(_elm_lang$core$Json_Decode$field, 'ts', _elm_lang$core$Json_Decode$float));
																														},
																														A2(_elm_lang$core$Json_Decode$field, 'tPoints_prev', _elm_lang$core$Json_Decode$int));
																												},
																												A2(_elm_lang$core$Json_Decode$field, 'tPoints', _elm_lang$core$Json_Decode$int));
																										},
																										A2(
																											_elm_lang$core$Json_Decode$field,
																											'tList',
																														...
																														return A2(
																															...
																															A2(
																																...
																																A2(
																																	...
																																	A2(_elm_lang$core$Json_Decode$field, 'delta', _elm_lang$core$Json_Decode$int))));
																													},
																													A2(
																														_elm_lang$core$Json_Decode$field,
																														'chist',
																								...
																								A2(_elm_lang$core$Json_Decode$field, 'roomChange', _elm_lang$core$Json_Decode$bool));
																						},
																						A2(_elm_lang$core$Json_Decode$field, 'points', _elm_lang$core$Json_Decode$int));
																				},
																				A2(_elm_lang$core$Json_Decode$field, 'name', _elm_lang$core$Json_Decode$string));
																		},
																		A2(_elm_lang$core$Json_Decode$field, 'min5', _elm_lang$core$Json_Decode$bool));
																},
																A2(_elm_lang$core$Json_Decode$field, 'min15', _elm_lang$core$Json_Decode$bool));
														},
														A2(_elm_lang$core$Json_Decode$field, 'message', _elm_lang$core$Json_Decode$string));
												},
												A2(
						...
						A2(_elm_lang$core$Json_Decode$field, 'error', _elm_lang$core$Json_Decode$bool))),
				_1: {ctor: '[]'}
			}
		}));
...
var Elm = {};
Elm['Fcc'] = Elm['Fcc'] || {};
if (typeof _user$project$Fcc$main !== 'undefined') {
    _user$project$Fcc$main(Elm['Fcc'], 'Fcc', {"types":{"unions":{"Dict.LeafColor":{"args":[],"tags":{"LBBlack":[],"LBlack":[]}},"Dict.Dict":{"args":["k","v"],"tags":{"RBNode_elm_builtin":["Dict.NColor","k","v","Dict.Dict k v","Dict.Dict k v"],"RBEmpty_elm_builtin":["Dict.LeafColor"]}},"Dict.NColor":{"args":[],"tags":{"BBlack":[],"Red":[],"NBlack":[],"Black":[]}},"Http.Error":{"args":[],"tags":{"BadUrl":["String"],"NetworkError":[],"Timeout":[],"BadStatus":["Http.Response String"],"BadPayload":["String","Http.Response String"]}},"Result.Result":{"args":["error","value"],"tags":{"Ok":["value"],"Err":["error"]}},"Update.Msg":{"args":[],"tags":{"FetchData":[],"StoreID":["String"],"Tick":["Time.Time"],"FetchAll":["Result.Result Http.Error Model.Member"],"GitterIDStatus":["Result.Result Http.Error (List Model.Gid)"],"UpdateSucceed":["Result.Result Http.Error Model.Member"],"Set15min":["Bool"],"GitterStatus":["Result.Result Http.Error (List Model.GRoom)"],"FetchGitter":[],"Set5min":["Bool"],"FetchOne":["Result.Result Http.Error Model.Member"],"StoreRoom":["String"]}}},"aliases":{"Http.Response":{"args":["body"],"type":"{ url : String , status : { code : Int, message : String } , headers : Dict.Dict String String , body : body }"},"Model.Member":{"args":[],"type":"{ uname : String, points : Int }"},"Model.GRoom":{"args":[],"type":"{ id : String, name : String, userCount : Int }"},"Model.Gid":{"args":[],"type":"{ username : String, displayName : String, avatarUrlSmall : String }"},"Time.Time":{"args":[],"type":"Float"}},"message":"Update.Msg"},"versions":{"elm":"0.18.0"}});
}
